...
cooper_folder <- "I:/Shared drives/IFI/Projects_Active/SanteeCooper_FERC_19-04-09/IFI_TASKS/Task_Y_SturgUseofLock/SCDNR-Data-Analysis-Tasks/Cooper River Detections_06_15_2026/"
...
output_path <- "I:/Shared drives/IFI/Projects_Active/SanteeCooper_FERC_19-04-09/IFI_TASKS/Task_Y_SturgUseofLock/SCDNR-Data-Analysis-Tasks/Cooper River Detections_06_15_2026/Cooper_River_Sturgeon_Detections_Combined.csv"
...
# Remove the incorrect file if needed
csv_files <- csv_files[!grepl("Incorrect", csv_files, ignore.case = TRUE)]
...
# Clean names BEFORE join to avoid case mismatches
...
message("✨ Cooper River sturgeon detections saved to:")
message(output_path)
